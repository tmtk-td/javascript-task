...
$(document).ready(function(){
  ...
  function get_pass_or_failure() {
    ...
    let number = [Number($('#national_language').val()),
                          Number($('#english').val()),
                          Number($('#mathematics').val()),
                          Number($('#science').val()),
                          Number($('#society').val())
  ...
  $('#btn-judge').click(function() {
    // 表示したい箇所のidもしくはclassを取得
    // 例: $("#evaluation").text(get_achievement());
    // 表示したい箇所のtextにget_pass_or_failureをいれる
...
// 例ではJavaScriptとjQueryの両方の記述を使用しているが、どちらかに統一しても構い
